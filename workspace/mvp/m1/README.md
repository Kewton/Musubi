...
> 状態：**未着手**（2026-09-16 時点。M0 は 2026-09-15 にクローズ。今のマイルストーンは M1.1）。本書は Issue を切り出す前の整理であり、手順書ではない。
>
> | 文書 | 中身 |
> |---|---|
...
| タイミング | 作業内容 |
|---|---|
| M1a の着手前 | `00-open-questions.md` の M1a の問いに答える（2026-09-15 済み）。<br>M1.1 の前の問い（Q14〜Q17）に答え、ロードマップを決定にする（2026-09-16 済み）。<br>M1.1 の Issue を起票した日を、M1a と M1.1 の着手日として記録する（期限は設けない。Q10） |
...
3. §10.2・§10.3 に沿って M1.1・M1.2 の Issue を起票し、Milestone に付ける
4. 起票した日を、M1a と M1.1 の着手日として記録する（期限は設けない。Q10）
